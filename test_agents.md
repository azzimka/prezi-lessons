...
- [ ] **CSS-размеры** соответствуют каноничной таблице (раздел 3) и не расходятся с другими уроками
- [ ] **Header brand/sub** не меняется от слайда к слайду внутри одного урока
